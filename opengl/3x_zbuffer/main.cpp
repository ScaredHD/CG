...
int main() {
    ...
    // shaders
    Shader shader1("../shader/object.vs", "../shader/object.fs");
    Shader shader2("../shader/object.vs", "../shader/object2.fs");
    Shader lightShader("../shader/light.vs", "../shader/light.fs");

    Model wingman("../model/wingman/wingman.obj");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // preview rotation
        Shader& shader = linearizedZ ? shader2 : shader1;
        shader.use();
        ...
        model = translate(model, vec3(0.0f, 0.0f, -10.0f * i));
...
GLFWwindow* init() {
    ...
    GLFWwindow* window =
        glfwCreateWindow(800, 600, "z-buffer", nullptr, nullptr);
    if (!window) {
